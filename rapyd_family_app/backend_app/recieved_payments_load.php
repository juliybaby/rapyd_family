...
$res= $db->prepare("SELECT count(*) as totalcount FROM payment_rapyd where recipient_id=:recipient_id  order by id");
...
$result = $db->prepare("SELECT * FROM payment_rapyd where recipient_id=:recipient_id  order by id DESC limit :row1, :rowpage");
