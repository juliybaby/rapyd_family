...
(password,fullname,email,photo,user_rank,user_verified,user_banned,created_time,timer1,data,status,points,levels,phone_no)
...
$statement1 = $db->prepare('INSERT INTO updates_data_rapyd
(total_fund_fund,total_fund_spend,total_employee,total_fund_available,creator_id,data)
                          values
(:total_fund_fund,:total_fund_spend,:total_employee,:total_fund_available,:creator_id,:data)');
...
$statement2 = $db->prepare('INSERT INTO payers_bankinfo
(creator_id)
                          values
(:creator_id)');
